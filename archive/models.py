...
class Technic(models.Model):
    ...
    name = models.CharField(max_length=256, null=False, blank=False, verbose_name="Название техники")
...
class TDriver(models.Model):
    ...
    driver_i = models.IntegerField(null=False, blank=False, verbose_name="id водителя")
...
class TTechnicDriver(models.Model):
    ...
    technic_i = models.IntegerField(null=False, blank=False, verbose_name='id транспортного средства')
...
class ApplicationTechnic(models.Model):
    ...
    technic_driver_i = models.IntegerField(null=False, blank=False, verbose_name='id отметки техники')
    description = models.TextField(max_length=1024, null=True, blank=True, verbose_name="Описание")
